...
;* Date/Time created: Wed Apr 24 21:24:53 2024                 *
;***************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c")
...
;	C:\PROGRA~3\MATLAB\tic2000\3P778C~1.INS\TIC28X~1.INS\ti-cgt-c2000_20.2.1.LTS\bin\ac2000.exe -@C:\\Users\\granttm2\\AppData\\Local\\Temp\\{06CC70A0-610D-400B-B6CC-291784D5D7F9} 
	.sect	".text"
	.clink
...
$C$DW$2	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$2, DW_AT_TI_begin_file("C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c")
	.dwattr $C$DW$2, DW_AT_TI_begin_line(0x05)
	.dwattr $C$DW$2, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$2, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c",line 6,column 1,is_stmt,address _hardwareTimer1Init,isa 0
...
_hardwareTimer1Init:
	...
	.dwpsn	file "C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c",line 10,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c",line 11,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c",line 15,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  15 | CpuTimer1Regs.TPR.all = 0x00;        /* no prescaler    */             
;  16 | #endif                                                                 
;----------------------------------------------------------------------
        MOV       @$BLOCKED(_CpuTimer1Regs)+6,#0 ; [CPU_ALU] |15| 
	.dwpsn	file "C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c",line 17,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  17 | StartCpuTimer1();                                                      
;----------------------------------------------------------------------
        AND       @$BLOCKED(_CpuTimer1Regs)+4,#0xffef ; [CPU_ALU] |17| 
	.dwpsn	file "C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c",line 18,column 1,is_stmt,isa 0
$C$DW$3	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$3, DW_AT_TI_return
        ...
        LRETR     ; [CPU_ALU] 
        ; return occurs ; [] 
	.dwattr $C$DW$2, DW_AT_TI_end_file("C:/Program Files/MATLAB/R2023a/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c")
